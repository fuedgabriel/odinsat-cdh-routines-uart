...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PF12     ------> ADC1_INP6
    */
    HAL_GPIO_DeInit(SUN_SENSOR_Y__3F12_GPIO_Port, SUN_SENSOR_Y__3F12_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PF14     ------> ADC2_INP6
    */
    HAL_GPIO_DeInit(SUN_SENSOR_X__3A3_GPIO_Port, SUN_SENSOR_X__3A3_Pin);

    HAL_GPIO_DeInit(GPIOF, SUN_SENSOR_Y__2F13_Pin|SUN_SENSOR_Y__1F14_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PH5     ------> ADC3_INP16
    */
    HAL_GPIO_DeInit(GPIOF, SUN_SENSOR_X__1_Pin|SUN_SENSOR_X__2_Pin|SUN_SENSOR_X__3_Pin);

    HAL_GPIO_DeInit(SUN_SENSOR_Y__1_GPIO_Port, SUN_SENSOR_Y__1_Pin);

    HAL_GPIO_DeInit(GPIOH, SUN_SENSOR_X__1H4_Pin|SUN_SENSOR_X__2H5_Pin);
